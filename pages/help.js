...
export default function BookmarkGuide() {
  const bookmarkCode = `javascript:(()=>{var d=document,o=d.createElement('div'),p=0;o.innerHTML='<div style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);background:#fff;padding:20px;border-radius:8px;box-shadow:0 2px 10px #0003;z-index:999999;text-align:center;font-family:sans-serif;"><div style="width:24px;height:24px;border:3px solid #ccc;border-top:3px solid #4CAF50;border-radius:50%;animation:spin 1s linear infinite;margin:0 auto 10px;"></div><style>@keyframes spin{0%{transform:rotate(0)}100%{transform:rotate(360deg)}}</style>Loading... <span id=pct>0%</span></div>';d.body.appendChild(o);var t=d.getElementById('pct'),i=setInterval(()=>{t.textContent=++p+'%';p>=100&&clearInterval(i)},160),s=d.createElement('script');s.src='https://www.maimaicustomrating.site/bookmark.js';s.onload=s.onerror=()=>setTimeout(()=>o.remove(),3e4);d.body.appendChild(s);setTimeout(()=>o.remove(),3e4)})();`;
